...
var baseUri = "http://drmusiccollectionoo.azurewebsites.net/api/music";
var outputElement = document.getElementById("output");
var buttonElement = document.getElementById("getAllButton");
var addRecordElement = document.getElementById("addButton");
var deleteRecordElement = document.getElementById("deleteButton");
...
function addRecord() {
    ...
    var addAlbumElement = document.getElementById("addAlbum");
    var addRecordLabelElement = document.getElementById("addRecordLabel");
    var addDurationInSecondsElement = document.getElementById("addDurationInSeconds");
    var addYearOfPublicationElement = document.getElementById("addYearOfPublication");
    var myID = Number(addIdElement.value);
    var myTitel = addTitleElement.value;
    var myArtist = addArtistElement.value;
    var myAlbum = addAlbumElement.value;
    var myRecordLabel = addRecordLabelElement.value;
    var myDurationInSeconds = Number(addDurationInSecondsElement.value);
    var myaddYearOfPublication = Number(addYearOfPublicationElement.value);
    var output = document.getElementById("addRecordDiv");
    // id is generated by the back-end (REST service)
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUri, { id: myID, title: myTitel, artist: myArtist, album: myAlbum, recordLabel: myRecordLabel, durationInSeconds: myDurationInSeconds, yearOfPublication: myaddYearOfPublication })
        .then(function (response) {
        // let message: string = "response " + response.status + " " + response.statusText;
        var message = "Record has been added! Refresh to see.";
        output.innerHTML = message;
    })
        .catch(function (error) {
        // output.innerHTML = error.message;
        var messageFail = "Adding of record failed...";
...
function deleteRecord() {
    ...
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(uri)
        ...
        var message = "Record has been deleted! Refresh to see.";
        output.innerHTML = message;
    })
        .catch(function (error) {
        if (error.response) {
